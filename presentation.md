...
Overview
========================================================
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**] (https://erajitkumar.shinyapps.io/Course-Project-Shiny-Application-and-Reproducible-Pitch-master/)
...
Both files can be found here: [GitHub repo](https://github.com/erajitkumar/Course-Project-Shiny-Application-and-Reproducible-Pitch)
